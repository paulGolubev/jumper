...
__pub_directx_D3DDEVTYPE_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DDEVTYPE
	mov	eax,0
	jmp	_446
_446:
	pop	ebx
...
__pub_directx_D3DCAPS9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DCAPS9
	mov	dword [ebx+8],0
	mov	dword [ebx+12],0
	mov	dword [ebx+16],0
	mov	dword [ebx+20],0
...
__pub_directx_D3DCLIPSTATUS9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DCLIPSTATUS9
	mov	dword [ebx+8],0
	mov	dword [ebx+12],0
	mov	eax,0
	jmp	_458
...
__pub_directx_D3DVIEWPORT9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DVIEWPORT9
	mov	dword [ebx+8],0
	mov	dword [ebx+12],0
	mov	dword [ebx+16],0
	mov	dword [ebx+20],0
...
__pub_directx_D3DMATERIAL9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DMATERIAL9
	fldz
	fstp	dword [ebx+8]
	fldz
	fstp	dword [ebx+12]
...
__pub_directx_D3DLIGHT9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DLIGHT9
	mov	dword [ebx+8],0
	fldz
	fstp	dword [ebx+12]
	fldz
...
__pub_directx_D3DVERTEXELEMENT9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DVERTEXELEMENT9
	mov	word [ebx+8],0
	mov	word [ebx+10],0
	mov	byte [ebx+12],0
	mov	byte [ebx+13],0
...
__pub_directx_D3DADAPTER_IDENTIFIER9_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_pub_directx_D3DADAPTER_IDENTIFIER9
	mov	dword [ebx+8],0
	mov	dword [ebx+12],0
	mov	dword [ebx+16],0
	mov	dword [ebx+20],0
	...
	mov	dword [ebx+992],0
	mov	dword [ebx+996],0
	mov	dword [ebx+1000],0
	mov	dword [ebx+1004],0
	mov	dword [ebx+1008],0
	mov	dword [ebx+1012],0
	mov	dword [ebx+1016],0
	mov	dword [ebx+1020],0
	mov	dword [ebx+1024],0
	mov	dword [ebx+1028],0
	mov	dword [ebx+1032],0
	mov	dword [ebx+1036],0
	mov	dword [ebx+1040],0
	mov	dword [ebx+1044],0
	mov	dword [ebx+1048],0
	mov	dword [ebx+1052],0
	mov	dword [ebx+1056],0
	mov	dword [ebx+1060],0
	mov	dword [ebx+1064],0
	mov	dword [ebx+1068],0
	mov	dword [ebx+1072],0
	mov	dword [ebx+1076],0
	mov	dword [ebx+1080],0
	mov	dword [ebx+1084],0
	mov	dword [ebx+1088],0
	mov	dword [ebx+1092],0
	mov	dword [ebx+1096],0
	mov	dword [ebx+1100],0
	mov	dword [ebx+1104],0
	mov	eax,0
	jmp	_488
_488:
	pop	ebx
